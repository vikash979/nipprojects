                   ...
                   success: function(response){
                    ...
                    for(var i=0;i<response.length;i++){
                      ...
                      arr.push(response[i]['menu_name'])
                        ...
                        {$(dashboard).append(`<div class="col-lg-12 col-sm-12 col-xs-12" style="padding-top:3%;" ><div class="col-lg-2 col-sm-2 col-xs-2"><span style="border-bottom:1px dotted grey"><i class="fa fa-file-pdf-o" style="font-size:40px;color:red"></i></span></div><div class="col-lg-10 col-sm-10 col-xs-10"><a href="#"><span style="text-align: justify;">${response[i]['ascsubmenu_count'][kk]['submenu_name']}</span></a></div></div>`)
                        ...
                        for (var kk = 0; kk<response[i]['ascpublicationsubmenu_count'].length;kk++)
                        {
                            ...
                            if (kk % 2 ==0)
                          {
                            $(dashboard).append(`<div class="col-lg-12 col-sm-12 col-xs-12" style="padding-top:3%;" ><span style="border-bottom:1px dotted grey"><img src="http://192.168.0.8:8088/static/images/abc1.png" class="rounded-circle" alt="Cinque Terre" width="10%" height="10%"> <input type="checkbox" id="${response[i]['ascpublicationsubmenu_count'][kk]['id']}" value="${response[i]['ascpublicationsubmenu_count'][kk]['id']}" name="megafol" onclick="megafolder(this.id,'${response[i]['menu_name']}')"></span>${response[i]['ascpublicationsubmenu_count'][kk]['submenu_name']}</div>`)
                        
                          }
                          else
                          {
                            $(dashboard).append(`<div class="col-lg-12 col-sm-12 col-xs-12" style="padding-top:3%" ><span style="border-bottom:1px dotted grey"><img src="http://192.168.0.8:8088/static/images/def1.png" class="rounded-circle" alt="Cinque Terre" width="10%" height="10%"> </span> <input type="checkbox" id="${response[i]['ascpublicationsubmenu_count'][kk]['id']}" value="${response[i]['ascpublicationsubmenu_count'][kk]['id']}" name="megafol" onclick="megafolder(this.id,'${response[i]['menu_name']}')">${response[i]['ascpublicationsubmenu_count'][kk]['submenu_name']}</div>`)
                    ...
                    ///////////////////////?Guidelines////////////////////////
                     ...
                     if (response[i]['menu_name'] =='Guidelines')
                        ...
                        for (var kk = 0; kk<response[i]['ascguideleinessubmenu_count'].length;kk++)
                        {
                          ...
                          if (kk % 2 ==0)
                          {
                            $(dashboard).append(`<div class="col-lg-12 col-sm-12 col-xs-12" style="padding-top:3%;" ><span style="border-bottom:1px dotted grey"><img src="http://192.168.0.8:8088/static/images/abc1.png" class="rounded-circle" alt="Cinque Terre" width="10%" height="10%"> <input type="checkbox" id="${response[i]['ascguideleinessubmenu_count'][kk]['id']}" value="${response[i]['ascguideleinessubmenu_count'][kk]['id']}" name="megafol" onclick="megafolder(this.id,'${response[i]['menu_name']}')"></span>${response[i]['ascguideleinessubmenu_count'][kk]['submenu_name']}</div>`)
                        
                          }
                          else
                          {
                            $(dashboard).append(`<div class="col-lg-12 col-sm-12 col-xs-12" style="padding-top:3%" ><span style="border-bottom:1px dotted grey"><img src="http://192.168.0.8:8088/static/images/def1.png" class="rounded-circle" alt="Cinque Terre" width="10%" height="10%"> </span> <input type="checkbox" id="${response[i]['ascguideleinessubmenu_count'][kk]['id']}" value="${response[i]['ascguideleinessubmenu_count'][kk]['id']}" name="megafol" onclick="megafolder(this.id,'${response[i]['menu_name']}')">${response[i]['ascguideleinessubmenu_count'][kk]['submenu_name']}</div>`)
        ...
        //////////////////////////////////////Standards///////////////////
                      if (response[i]['menu_name'] =='Standards')
                        ...
                        for (var kk = 0; kk<response[i]['standards'].length;kk++)
                        {
                          ...
                          {
                            $(dashboard).append(`<div class="col-lg-12 col-sm-12 col-xs-12" style="padding-top:3%" ><span style="border-bottom:1px dotted grey"><img src="http://192.168.0.8:8088/static/images/def1.png" class="rounded-circle" alt="Cinque Terre" width="10%" height="10%"> </span> <input type="checkbox" id="${response[i]['standards'][kk]['id']}" value="${response[i]['standards'][kk]['id']}" name="megafol" onclick="megafolder(this.id,'${response[i]['menu_name']}')">${response[i]['standards'][kk]['submenu_name']}</div>`)
          ...
          if (response[i]['menu_name'] =='Navy Orders')
                        ...
                        for (var kk = 0; kk<response[i]['navy_ordersCount'].length;kk++)
                        {
                            if (kk % 2 ==0)
                          {
                            $(dashboard).append(`<div class="col-lg-12 col-sm-12 col-xs-12" style="padding-top:3%;" ><span style="border-bottom:1px dotted grey"><img src="http://192.168.0.8:8088/static/images/navy_orders.png" class="rounded-circle" alt="Cinque Terre" width="10%" height="10%"> <input type="checkbox" id="${response[i]['navy_ordersCount'][kk]['id']}" value="${response[i]['navy_ordersCount'][kk]['id']}" name="megafol" onclick="megafolder(this.id,'${response[i]['menu_name']}')"></span>${response[i]['navy_ordersCount'][kk]['submenu_name']}</div>`)
                        
                          }
                          else
                          {
                            $(dashboard).append(`<div class="col-lg-12 col-sm-12 col-xs-12" style="padding-top:3%" ><span style="border-bottom:1px dotted grey"><img src="http://192.168.0.8:8088/static/images/avy_orders.png" class="rounded-circle" alt="Cinque Terre" width="10%" height="10%"> </span> <input type="checkbox" id="${response[i]['navy_ordersCount'][kk]['id']}" value="${response[i]['navy_ordersCount'][kk]['id']}" name="megafol" onclick="megafolder(this.id,'${response[i]['menu_name']}')">${response[i]['navy_ordersCount'][kk]['submenu_name']}</div>`)
                     ...
                     if (response[i]['menu_name'] =='Navy Instructions')
                        ...
                        for (var kk = 0; kk<response[i]['navyInstrctionCount'].length;kk++)
                        {
                          ...
                          {
                            $(dashboard).append(`<div class="col-lg-12 col-sm-12 col-xs-12" style="padding-top:3%" ><span style="border-bottom:1px dotted grey"><img src="http://192.168.0.8:8088/static/images/def1.png" class="rounded-circle" alt="Cinque Terre" width="10%" height="10%"> </span> <input type="checkbox" id="${response[i]['navyInstrctionCount'][kk]['id']}" value="${response[i]['navyInstrctionCount'][kk]['id']}" name="megafol" onclick="megafolder(this.id,'${response[i]['menu_name']}')">${response[i]['navyInstrctionCount'][kk]['submenu_name']}</div>`)
